...
namespace render {
	...
	void draw_border_line_vertical(std::int32_t x1, std::int32_t y1, std::int32_t x2, std::int32_t y2, color colour);
	void draw_border_line_horizontal(std::int32_t x1, std::int32_t y1, std::int32_t x2, std::int32_t y2, color colour);
	...
	namespace fonts {
		...
		extern unsigned long button_font;
	}
}
